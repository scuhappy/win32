---
Description: The CreateDIB method creates a GDI device-independent bitmap (DIB). The DIB is allocated in a shared memory block, which eliminates a copy operation when the owning filter blits the image.
